...
This rule-based text analysis algorithm is able to utilize multiple cores of a processor and is designed to run on a server as an engine to process hundreds of text files. The algorithm takes URLs and id as input and calculates the below scores and metrics</br>
```json
calc_values = {
