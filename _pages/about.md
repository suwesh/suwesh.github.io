...
My expertise spans Machine Learning, Deep Learning, distributed and heterogeneous computing, with hands-on experience working with Hugging Face open-source models, LLM APIs, and deploying these models for GPU-accelerated inference across local and cloud platforms such as AWS. I’m particularly interested in how intelligent workloads can be designed, optimized, and distributed across computing environments with a growing focus on High Performance Computing.
