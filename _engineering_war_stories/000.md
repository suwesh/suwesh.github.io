...
The first demo to the CTO. He bore the slowness. But he saw what the bottleneck was. Not the software nor the architecture. Just compute. Then they trusted me enough to ask if I wanted AWS. I thought for a moment that if I got AWS, I would still have to work on this 14-inch laptop, which I could not bear with. So I asked for a Workstation instead (probably the best save of my early career). 
